...
{:else if name === "refresh"}
  <svg viewBox="0 0 24 24" width="18" height="18" class={`svg refresh ${style}`} on:click={onClick}
    ><path
      d="M17.65 6.35A8 8 0 1 0 20 12h-2a6 6 0 1 1-1.76-4.24L14 10h8V2l-4.35 4.35z"
    /></svg
  >
{:else if name === "calendar"}
  <svg viewBox="0 0 24 24" width="18" height="18" class={`svg calendar ${style}`} on:click={onClick}
    ><path
      d="M7 2v2m10-2v2M4 7h16M5 4h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1zm0 5h14"
      fill="none"
      stroke="currentColor"
      stroke-width="1.8"
  ...
  >
{:else if name === "plus"}
  <svg viewBox="0 0 24 24" width="18" height="18" class={`svg plus ${style}`} on:click={onClick}
    ><path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2" stroke-linecap="round" /></svg
  >
{:else if name === "trash"}
  <svg viewBox="0 0 24 24" width="18" height="18" class={`svg trash ${style}`} on:click={onClick}
    ><path
      d="M3 6h18M8 6V4h8v2m-7 0 .6 12.1c.1 1 .9 1.9 1.9 1.9h3.2c1 0 1.8-.8 1.9-1.9L17 6M10 10v6M14 10v6"
      fill="none"
      stroke="currentColor"
      stroke-width="1.8"
      stroke-linecap="round"
